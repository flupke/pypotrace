...
:meth:`Bitmap.trace` returns :class:`Path` instances, containing 
...
:class:`Path` are made of a list of :class:`Curve` objects:
...
can check the :attr:`is_corner` attribute to determine their type easily.
